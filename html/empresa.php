                                            ...
                                            <form class="form-horizontal" id="empresa_form" name="empresa_form" method="post"  enctype="multipart/form-data" action="../procesos/guardar_empresa.php">
                                                <fieldset>
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="ruc_empresa">Ruc empresa: <font color="red">*</font></label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="propietario_empresa">Propietario: <font color="red">*</font></label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="telefono_empresa">Telefóno: <font color="red">*</font></label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="fax_empresa">Fax: </label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="pagina_empresa">Página Web: </label>
                                                        <div class="controls2">
                                                    ...
                                                    <div id="logo" style="margin-left: 800px; margin-top: -270px; border: solid 1px; width: 220px; height: 180px" title="LOGO">
