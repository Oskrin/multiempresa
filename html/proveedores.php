                                            ...
                                            <form class="form-horizontal" id="proveedores_form" name="proveedores_form" method="post">
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">											
                                                        ...
                                                        <label class="control-label2" for="representante_legal">Representante Legal: </label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">											
                                                        ...
                                                        <label class="control-label2" for="direccion_pro">Dirección: <font color="red">*</font></label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label2" for="fax">Fax: </label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">											
                                                        ...
                                                        <label class="control-label2" for="ciudad_pro">Ciudad: <font color="red">*</font> </label>
                                                        <div class="controls2">
                                                    ...
                                                    <div class="control-group">											
                                                        ...
                                                        <label class="control-label2" for="principal_pro">Proveedor Principal: <font color="red">*</font></label>
                                                        <div class="controls2">
