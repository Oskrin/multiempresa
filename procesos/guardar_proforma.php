...
//
////////////guardar proforma////////
pg_query("insert into proforma values('$cont1','$_POST[id_cliente]','$_SESSION[id]','$_SESSION[id_empresa]','$_POST[comprobante]','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[tipo_precio]'
