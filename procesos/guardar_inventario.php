...
pg_query("insert into inventario values('$cont1','$_SESSION[id]','$_SESSION[id_empresa]','$_POST[comprobante]','$_POST[fecha_actual]','$_POST[hora_actual]','Activo')");
////////////////////////////////////////
//
...
for ($i = 0; $i <= $nelem; $i++) {
    ...
    pg_query("Update productos Set precio_compra='" . $arreglo2[$i] . "', iva_minorista = '" . $format_numero . "' , iva_mayorista = '" . $format_numero2 . "' ,stock='" . $arreglo4[$i] . "' ,existencia='" . $arreglo4[$i] . "', diferencia='" . $arreglo6[$i] . "' where cod_productos='" . $arreglo1[$i] . "' and id_empresa = '$_SESSION[id_empresa]'");
    ///////////////////////////////////////////
}
$data = 1;
echo $data;
