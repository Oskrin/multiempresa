...
$consulta = pg_query("select * from factura_venta order by id_factura_venta asc");
...
//
//////////////contador clientes///////////////////
$consulta_cli = pg_query("select * from clientes order by id_cliente asc");
...
/////////////////modificar proformas///////////
if ($_POST['proforma'] != "") {
    pg_query("Update proforma Set estado='Pasivo' where id_proforma='" . $_POST['proforma'] . "' and id_empresa = '$_SESSION[id_empresa]'");
}
...
if ($forma === "Credito") {
    ...
    pg_query("insert into pagos_venta values('$cont2','$_POST[id_cliente]','$cont1','$_SESSION[id]','$_POST[fecha_actual]','$adelanto','$meses','Factura','$format','$format','Activo','$_SESSION[id_empresa]')");
    /////////////////////////////////////////////////////////
    //
    ////////////////Guardar meses///////////////////////////
    if ($meses > 1) {
