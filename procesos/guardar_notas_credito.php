...
pg_query("insert into devolucion_venta values('$cont1','$_SESSION[id_empresa]','$_POST[id_cliente]','$_SESSION[id]','$_POST[comprobante]','$_POST[fecha_actual]','$_POST[hora_actual]'
