...
if ($_POST['oper'] == "edit") {
    pg_query("update categoria set id_categoria='$_POST[id_categoria]', nombre_categoria='$_POST[nombre_categoria]' where id_categoria='$_POST[id_categoria]' and id_empresa = '$_SESSION[id_empresa]'");
}
?>
