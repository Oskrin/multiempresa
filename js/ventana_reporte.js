...
function ventana(e){
	modal.open({content: "<input type='radio' name='group1' id='excel' value='Reporte en Excel' > <label for='excel'>Reporte en Excel</label> <br><input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br> <label>Tamaño de Hoja</label> <select onchange='return fn_cambio(event)' name='tam_hoja' id='tam_hoja' style='width:100px' ><option value='A4'>A4</option><option value='A3'>A3</option><option value='A5'>A5</option><option value='Letter'>Carta</option><option value='Legal'>Legal</option><option value='Personalizar'>Personalizar</option></select><br><br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte' onclick='return fn_reporte(event)' href='#'>Generar Reporte</a>"});
...
function fn_reporte(e){
    ...
    if($('#excel').is(':checked')){    	
    	...
    	{
    		window.open('../reportes_sistema/reporte_productos.php?hoja='+hoja+"&w=73"+"&h="+$("#largo").val(), '_blank');	
    	}
    	else{
    		window.open('../reportes_sistema/reporte_productos.php?hoja='+hoja, '_blank');		
    	}
    }  
    modal.close();  
}
function ventana_mar_cat(e){	
	modal.open({content: "<input type='radio' name='group1' id='excel' value='Reporte en Excel' > <label for='excel'>Reporte en Excel</label> <br><input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br><label>Categorías</label><select id='sel_categoria' style='width:150px;float:right'></select><br><label>Marcas</label><select id='sel_marcas' style='width:150px;float:right'></select><br><label>Tamaño de Hoja</label> <select onchange='return fn_cambio(event)' name='tam_hoja' id='tam_hoja' style='width:100px;float:right' ><option value='A4'>A4</option><option value='A3'>A3</option><option value='A5'>A5</option><option value='Letter'>Carta</option><option value='Legal'>Legal</option><option value='Personalizar'>Personalizar</option></select><br><br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte_mar_cat' onclick='return fn_reporte_mar_cat(event)' href='#'>Generar Reporte</a>"});
...
function fn_reporte_mar_cat(e){
    ...
    if($('#excel').is(':checked')){    	
    	...
    	if(document.getElementById("tam_hoja").value=='Personalizar')
    	{
    		window.open('../reportes_sistema/reporte_categoria_marcas.php?hoja='+hoja+"&w=73"+"&h="+$("#largo").val()+'&marca='+$("#sel_marcas").val()+'&categoria='+$("#sel_categoria").val(), '_blank');	
    	}
    	else{
    		window.open('../reportes_sistema/reporte_categoria_marcas.php?hoja='+hoja+'&marca='+$("#sel_marcas").val()+'&categoria='+$("#sel_categoria").val(), '_blank');		
    	}
    }  
    modal.close();  
}
...
function fn_reporte_existencia(e){
    ...
    if($('#excel').is(':checked')){    	
    	...
    	if(document.getElementById("tam_hoja").value=='Personalizar')
    	{
    		window.open('../reportes_sistema/reporte_existencia_minima.php?hoja='+hoja+"&w=73"+"&h="+$("#largo").val(), '_blank');	
    	}
    	else{
    		window.open('../reportes_sistema/reporte_existencia_minima.php?hoja='+hoja, '_blank');		
    	}
    }  	
}
...
function ventana_agrupados_prov(e){ 
    modal.open({content: "<label for='buscarProv'>Buscar</label><input type='text' name='buscarProv' id='buscarProv' /><input type='hidden' id='idProv' /><br><input type='radio' name='group1' id='excel' value='Reporte en Excel' > <label for='excel'>Reporte en Excel</label> <br><input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br> <label>Tamaño de Hoja</label> <select onchange='return fn_cambio(event)' name='tam_hoja' id='tam_hoja' style='width:100px' ><option value='A4'>A4</option><option value='A3'>A3</option><option value='A5'>A5</option><option value='Letter'>Carta</option><option value='Legal'>Legal</option><option value='Personalizar'>Personalizar</option></select><br><br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte_agrupados_prov' onclick='return fn_reporte_agrupados_prov(event)' href='#'>Generar Reporte</a>"});
...
function fn_reporte_agrupados_prov(e){
    ...
    if($('#excel').is(':checked')){     
        ...
        if(document.getElementById("tam_hoja").value=='Personalizar')
        {
            window.open('../reportes_sistema/reporte_agrupados_prov.php?hoja='+hoja+"&w=73"+"&h="+$("#largo").val()+"&id="+$('#idProv').val(), '_blank');  
        }
        else{
...
function ventana_factura_compra(e){ 
    modal.open({content: "<label for='buscarNumero'>Buscar Factura: </label><input type='text' name='buscarNumero' id='buscarNumero' /><input type='hidden' id='idFac' /><br><input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br> <br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte_factura_compra' onclick='return fn_reporte_factura_compras(event)' href='#'>Generar Reporte</a>"});
...
function ventana_factura_venta(e){ 
    modal.open({content: "<label for='buscarNumero'>Buscar Factura: </label><input type='text' name='buscarNumero' id='buscarNumero' /><input type='hidden' id='idFac' /><br><input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br> <label>Tamaño de Hoja</label> <select onchange='return fn_cambio(event)' name='tam_hoja' id='tam_hoja' style='width:100px' ><option value='A4'>A4</option><option value='A3'>A3</option><option value='A5'>A5</option><option value='Letter'>Carta</option><option value='Legal'>Legal</option><option value='Personalizar'>Personalizar</option></select><br><br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte_factura_venta' onclick='return fn_reporte_factura_venta(event)' href='#'>Generar Reporte</a>"});
    $("#buscarNumero").autocomplete({
...
function fn_reporte_factura_venta(e){
    ...
    if($('#excel').is(':checked')){     
        ...
        if(document.getElementById("tam_hoja").value=='Personalizar')
        {
            window.open('../reportes_sistema/factura_venta.php?hoja='+hoja+"&w=73"+"&h="+$("#largo").val()+"&id="+$('#idFac').val(), '_blank');  
        }
        else{
            window.open('../reportes_sistema/factura_venta.php?hoja='+hoja+"&id="+$('#idFac').val(), '_blank');      
        }
    }   
}
...
function proformas(e){ 
    modal.open({content: "<label for='buscarProforma' style='padding:6px;'>Buscar</label><input type='text' name='buscarProforma' id='buscarProforma' style='float: right;padding:2px;' /><input type='hidden' id='idProf' /><br><input type='radio' name='group1' id='excel' value='Reporte en Excel' > <label for='excel'>Reporte en Excel</label> <input type='radio' name='group1' id='pdf' value='Reporte Pdf' checked> <label for='pdf'>Reporte Pdf</label> <br><a 'id='generar' style='cursor:pointer;font-size:12px;margin-left:40px' class='generarReporte_proforma' onclick='return fn_proformas(event)' href='#'>Generar Reporte</a>"});
