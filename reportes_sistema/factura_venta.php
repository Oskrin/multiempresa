...
class PDF extends PDF_Rotate
{
	...
	if($_GET['hoja']=='A4'){
		...
		{		
			...
			$pdf->SetFont('Arial','',8); 		
			$pdf->Cell(55,40,'',0,1,'C');				 			
			$pdf->Text(25,57,utf8_decode(''.strtoupper($fila[8])),0,'C', 0);	
			$pdf->Text(25,63,utf8_decode(''.strtoupper($fila[9])),0,'C', 0);	
			$pdf->Text(25,69,utf8_decode(''.strtoupper($fila[10])),0,'C', 0);	
			$pdf->Text(25,76,utf8_decode(''.strtoupper($fila[11])),0,'C', 0);	
			$pdf->Text(115,76,utf8_decode(''.strtoupper($fila[12])),0,'C', 0);			
			$pdf->Text(180,57,utf8_decode(strtoupper($fila[13])),0,'C', 0);
			$pdf->Text(180,63,utf8_decode(strtoupper($fila[14])),0,'C', 0);
			$pdf->Text(183,69,utf8_decode(strtoupper($fila[15])),0,'C', 0);			
			$pdf->Ln(20);							
		}		           
	}	
	///////////////
