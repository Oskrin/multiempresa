        ...
        while($row=pg_fetch_row($consulta)){
            ...
            while($row2=pg_fetch_row($consulta2)){
                ...
                while($row3=pg_fetch_row($consulta3)){
                    $codigo.='<table border=0>';                                                
                    $codigo.='<tr>                
                    <td style="width:70px">'.'&nbsp;'.$row2[4].'</td>
                    <td style="width:70px">'.'&nbsp;FV'.'</td>                    
                    <td style="width:70px">'.'&nbsp;'.$row3[4].'</td>
                    <td style="width:70px">'.'&nbsp;'.($row3[7]+$row3[5]).'</td>';                                   
                    $codigo.='<td style="width:70px">'.($row3[7]+$row3[5]).'</td></tr>'; 
                    $total=($row3[7]+$row3[5]);         
                    $codigo.='</table>'; 
                    if($row3[5]!=""){
                        $codigo.='<table border=0>';                                                
                        ...
                        $total=$total-$row3[5];
                        $codigo.='<td style="width:70px">'.($row3[7]).'</td></tr>';          
                        $codigo.='</table>'; 
                    }
